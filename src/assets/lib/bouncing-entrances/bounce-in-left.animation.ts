  ...
  animation(
    group([
      animate(
        ...
        style({ transform: 'perspective(25px) rotateY(-100deg) translateY(30px) translateX(150px) translateZ(50px)', opacity: 1, easing: 'cubic-bezier(0.895, 0.03, 0.685, 0.22)', offset: 0 }),
